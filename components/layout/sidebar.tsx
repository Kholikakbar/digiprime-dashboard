...
export function Sidebar() {
    ...
    return (
        <div className="flex flex-col h-screen w-72 bg-white dark:bg-slate-950 border-r border-slate-200 dark:border-slate-800/60 shadow-[0_0_50px_-12px_rgba(0,0,0,0.05)] transition-all duration-500 overflow-hidden relative">
            ...
            {/* Logo Section */}
            <div className="px-8 pt-10 pb-8 flex flex-col gap-1 select-none relative z-10">
                <Link href="/" className="flex items-center gap-3.5 group">
                    <div className="relative w-11 h-11 bg-gradient-to-tr from-primary to-purple-600 p-2.5 rounded-2xl shadow-xl shadow-primary/20 group-hover:scale-105 transition-transform duration-300">
                        <Image
                            src="/logo.png"
                            alt="DigiPrime"
                            fill
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3.5 relative z-10">
                                ...
                                <span className={`text-[14px] font-bold tracking-tight transition-colors duration-300 ${isActive ? 'text-slate-900 dark:text-white' : 'group-hover:text-slate-900 dark:group-hover:text-white'
                                    }`}>
                                    {route.label}
                                </span>
                            </div>
                            ...
                            {isActive && (
                                <motion.div
                                    ...
                                    className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 rounded-r-full ${route.bgColor}`}
                                />
                            )}
                        </Link>
                    )
            ...
            <div className="p-4 mt-auto border-t border-slate-100 dark:border-slate-800/60 relative z-10 bg-white/50 dark:bg-slate-950/50 backdrop-blur-md">
                ...
                <button
                    ...
                    className="flex items-center justify-center gap-3 w-full py-3.5 rounded-2xl text-[13px] font-bold text-red-500 hover:text-white bg-red-500/5 hover:bg-red-500 border border-red-500/10 hover:border-red-500 transition-all duration-300 shadow-sm hover:shadow-lg hover:shadow-red-500/30 group"
                >
