...
export function Navbar({ user }: { user: any }) {
    ...
    return (
        <>
            ...
            <div className="flex items-center px-6 py-4 bg-transparent sticky top-0 z-40 mb-2">
                <button
                ...
                <div className="ml-auto flex items-center gap-2 sm:gap-4">
                    ...
                    <div className="flex items-center gap-3 pl-4">
                        {/* User Text Removed as per request "Logo Saya Aja" */}
                        <div className="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 text-sm font-bold overflow-hidden relative border border-slate-200">
